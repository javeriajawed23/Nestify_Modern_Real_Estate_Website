    ...
    <div className="space-y-6">
      {!submitted ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="rounded-lg border bg-white p-6 shadow-sm space-y-6">
              <div>
                ...
                >
                  <div className="flex items-center space-x-2 rounded-lg border border-muted bg-slate-50 p-3 transition-all hover:bg-amber-50 hover:border-amber-200">
                    <RadioGroupItem value="in-person" id="in-person" />
                    <Label
                      htmlFor="in-person"
                      className="flex items-center gap-2 font-normal cursor-pointer"
                    >
                      <Users className="h-4 w-4 text-orange-700" /> In-Person Tour
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2 rounded-lg border border-muted bg-slate-50 p-3 transition-all hover:bg-amber-50 hover:border-amber-200">
                    ...
                    <Label
                      ...
                      className="flex items-center gap-2 font-normal cursor-pointer"
                    >
                      <Video className="h-4 w-4 text-orange-700" /> Video Tour
                    </Label>
                  </div>
                </RadioGroup>
              </div>
              ...
              <div className="grid gap-6 md:grid-cols-2">
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Select>
                      <SelectTrigger className="transition-all focus:border-amber-300 focus:ring-amber-200 w-full">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      required
                      className="transition-all focus:border-amber-300 focus:ring-amber-200"
                    />
                  </div>
            ...
            <Button
              type="submit"
              className="w-full bg-orange-700 hover:bg-orange-800 cursor-pointer"
            >
              Schedule Tour
            </Button>
          </form>
        ...
        <div className="rounded-lg border bg-amber-50 p-8 text-center">
          ...
          <Button
            className="mt-6 bg-orange-700 hover:bg-orange-800"
