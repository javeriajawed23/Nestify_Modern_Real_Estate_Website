...
export default function MortgageCalculator({ propertyPrice }) {
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-2xl font-bold text-orange-700">Mortgage Calculator</h2>
        ...
        <div className="space-y-4 rounded-lg border bg-white p-6 shadow-sm">
          <div className="space-y-2">
            ...
            <Input
              ...
              className="transition-all focus:border-orange-400 focus:ring-orange-300"
            />
          </div>
        ...
        <Card className="overflow-hidden border-0 shadow-md">
          ...
          <CardContent className="p-6">
            <div className="space-y-4">
              ...
              <div className="flex justify-between rounded-lg bg-orange-50 p-4">
