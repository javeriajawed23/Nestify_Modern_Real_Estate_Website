    ...
    <>
      ...
      <div className="relative overflow-hidden rounded-xl">
        ...
        <Button
          ...
          className="absolute bottom-4 right-4 z-10 rounded-full bg-amber-100/90 hover:bg-amber-200 transition shadow-md backdrop-blur-sm hover:scale-105 cursor-pointer"
        >
        ...
        <DialogContent className="max-w-5xl p-0 bg-black">
          <div className="relative h-screen w-full">
            ...
            <Button
              variant="outline"
              size="icon"
              className="absolute top-1/2 left-4 -translate-y-1/2 bg-amber-100/90 rounded-full backdrop-blur-sm hover:scale-110 cursor-pointer"
              onClick={prevImage}
            >
            ...
            <Button
              variant="outline"
              size="icon"
              className="absolute top-1/2 right-4 -translate-y-1/2 bg-amber-100/90 rounded-full backdrop-blur-sm hover:scale-110 cursor-pointer"
              onClick={nextImage}
            >
            ...
            <Button
              variant="outline"
              size="icon"
              className="absolute top-4 right-4 bg-amber-100/90 rounded-full backdrop-blur-sm hover:scale-110 cursor-pointer"
